    ...
    >
      <div className="p-5 sm:p-6">
        ...
        <div className="mt-4 rounded-xl border border-destructive/35 bg-destructive/10 p-3.5">
          ...
          >
            <ButtonLoading loading={pendingAction === "unlink" && isPending} />
            Unlink permanently
          </Button>
        </div>
      ...
      <div className="flex flex-col-reverse justify-end gap-2 border-t bg-muted/35 px-5 py-4 sm:flex-row sm:px-6">
        <Button
          type="button"
          variant="outline"
          disabled={isPending}
        ...
        >
          <ButtonLoading loading={pendingAction === "override" && isPending} />
